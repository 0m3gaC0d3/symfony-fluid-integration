...
/**
 * Extends the original TYPO3Fluid Rendering Context to add the DI Container.
 */
class RenderingContext extends \TYPO3Fluid\Fluid\Core\Rendering\RenderingContext
{
    ...
    public function __construct(ViewInterface $view)
    {
        ...
        $this->viewHelperResolver->addNamespace('f', 'OmegaCode\FluidIntegration\ViewHelpers');
    }
